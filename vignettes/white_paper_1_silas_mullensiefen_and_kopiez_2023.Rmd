...
We discuss the importance of assessing musical production, particularly singing, and its integration with melodic memory research. We highlight some key points:
...
- Experiment 2 aimed to work towards creating an adaptive singing test by adding new features and change the procedure to produce cleaner data.
