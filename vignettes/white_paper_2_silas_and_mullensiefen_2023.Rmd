...
9. Target Melody Length Affects Sung Recall Performance *Via* The Attempt Length: In a mediation model, we show that longer melodies lead to longer attempts, which generally result in higher melodic similarity scores. However, the increased complexity of longer melodies negatively affects melodic similarity scores, balancing out the overall bivariate relationship, making it statistically insignificant.
