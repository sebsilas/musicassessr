...
### 2.1.1: Melody No. 1, Children of the Night, R.Marx
...
### 2.1.2: Melody No. 2, Climb Up,	N.Sedaka
...
### 2.1.3: Melody No. 3, Cold Cold Heart,	M.Pellow
...
### 2.1.5: Melody No. 5, Du gehörst zu mir, J. Heider
...
### 2.1.6: Melody No. 6, Longer, D.Fogelberg
...
### 2.1.7: Melody No. 7, Oh Carol, N. Sedaka
...
### 2.1.8: Melody No. 8, Take Good Care, C. King
...
### 2.1.9: Melody No. 9, The Sky is Crying, M.Levy
...
### 2.1.10: Melody No. 10, You Are My Destiny, P. Anka
...
### 2.1.11: Melody No. 11, Goodbye My Love Goodbye,	M. Panas / D. Roussos
...
### 2.1.12: Melody No. 12,	Enjoy Your Life, Funky Be
...
### 2.1.13: Melody No. 13, Love Is Like A Rainbow, T. Anders
...
### 2.1.14: Melody No. 14, Let Me Be Your Only One, Funky Be
...
## 2.2 Description and distribution of melodic features
...
## 2.3 Melodic feature summary statistics
...
# 3.2 Factor loadings for mixed type variables based on questionnaire items
...
# 4.0 Average by-participant across trials
...
# 4.2  Average by-participant development of opti3 across trials
...
# 5.1 Average by-melody development of attempt across trials
...
# 6.0 Linear vs. Non-Linear Models attempt length and opti3
...
## Appendix 6.2: Linear model of mean similarity scores (opti3) across repeated attempts
...
# 7.0 Diagnostic statistics for models with all features in (partial R-squared and variance inflation factor values)
...
# 8.0 Counts of overall number of trials that participants utilise for multiple attempts
...
# 9.0 Statistical models to support changes in similarity as a function of attempt and melody section
