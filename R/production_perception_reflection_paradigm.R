...
production_reflection_perception_paradigm_protocol <- function(stimuli = c(60, 61, 62, 63),
  ...
  psychTestR::module("production_reflection_perception_paradigm_protocol",
    psychTestR::join(
      ...
      psychTestR::reactive_page(function(state, ...) {
        ...
        present_stimuli(
          ...
          db_vars = create_db_vars_template(attempt = attempt,
                                            ...
                                            feedback = TRUE,
                                            feedback_type = "opti3",
                                            page_label = paste0("production_reflection_perception.production.attempt_", attempt),
      ...
      rate_similarity(label = paste0("production_reflection_perception.reflection_rating.attempt_", attempt),
      ...
      psychTestR::reactive_page(function(state, ...) {
          ...
          rate_similarity(label = paste0("production_reflection_perception.perception_rating.attempt_", attempt),
                          labels = c("Not good", "Quite good", "Very good", "Perfect"),
                          prompt = shiny::tags$div(
                            ...
                            shiny::tags$div(id = "audio_feedback_wrapper",
                                            style = "display: none;",
                              shiny::tags$p("And now here is what you played:"),
                            ...
                            shiny::tags$script(shiny::HTML("
                                document.getElementById('audio_feedback').addEventListener('ended', function() {
