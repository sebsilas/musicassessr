  ...
  if(with_examples) {
    psychTestR::NAFC_page(
      ...
      '<p><strong>Soprano</strong></p>
        <audio controls>
        <source src="https://adaptiveeartraining.com/assets/audio/voice_ranges/soprano_voice_no_intro.m4a" type="audio/mp4">
          ...
          <audio controls>
          <source src="https://adaptiveeartraining.com/assets/audio/voice_ranges/alto_voice_no_intro.m4a" type="audio/mp4">
            Your browser does not support the audio element.
          </audio>

            <p><strong>Tenor</strong></p>
            <audio controls>
            <source src="https://adaptiveeartraining.com/assets/audio/voice_ranges/tenor_voice_no_intro.m4a" type="audio/mp4">
              Your browser does not support the audio element.
            </audio>

              <p><strong>Baritone</strong></p>
              <audio controls>
              <source src="https://adaptiveeartraining.com/assets/audio/voice_ranges/baritone_voice_no_intro.m4a" type="audio/mp4">
                Your browser does not support the audio element.
              </audio>

                <p><strong>Bass</strong></p>
                <audio controls>
                <source src="https://adaptiveeartraining.com/assets/audio/voice_ranges/bass_voice_no_intro.m4a" type="audio/mp4">
                  Your browser does not support the audio element.
                </audio>')),
